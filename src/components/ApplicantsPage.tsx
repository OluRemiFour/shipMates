...
const mockApplicants: Applicant[] = [
  ...
  },
  {
    ...
    role: 'backend',
    matchScore: 85,
    bio: 'Backend engineer focused on scalable systems and API design.',
  ...
  },
  {
    ...
    role: 'designer',
    matchScore: 78,
    bio: 'Product designer with a focus on user research and design systems.',
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 font-sans">{applicant.appliedAt}</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {applicant.status === 'pending' ? (
                        <div className="flex gap-2">
                          <Button
                            size="icon"
                            onClick={(e) => { e.stopPropagation(); handleAccept(applicant.id); }}
                          ...
                          <Button
                            size="icon"
                            onClick={(e) => { e.stopPropagation(); handleReject(applicant.id); }}
